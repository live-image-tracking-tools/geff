    ...
    "Python Benchmark with pytest-benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1cc3a3cbfa375b78ca3ff6e7267861ed41dbcba8",
          "message": "Flexible testing utils to create dummy graphs with full freedom  (#161)\n\n# Proposed Change\n- flexible test function to create dummy graph with full freedom over\ndtype/nodes/edges/numbers/props/etc\n- retyped all inputs throughout the repo to be a zarr `StoreLike` (str |\nPath | store)\n- added `pixi run test-cov` to run test and print coverage report\n\n# Types of Changes\nWhat types of changes does your code introduce?\n- New feature or enhancement\n- Tests\n\nWhich topics does your change affect?\n- testing\n\n# Checklist\nPut an x in the boxes that apply. You can also fill these out after\ncreating the PR. If you're unsure about any of them, don't hesitate to\nask. We're here to help! This is simply a reminder of what we are going\nto look for before merging your code.\n\n- [x] I have read the\n[developer/contributing](https://github.com/live-image-tracking-tools/geff/blob/main/CONTRIBUTING)\ndocs.\n- [x] I have added tests that prove that my feature works in various\nsituations or tests the bugfix (if appropriate).\n- [x] I have checked that I maintained or improved code coverage.\n- [x] I have written docstrings and checked that they render correctly.\n\n## If you changed the specification\n- [x] I have checked that any validation functions and tests reflect the\nchanges.\n- [x] I have updated the GeffMetadata and the json schema using `pixi\nrun update-schema` if necessary.\n- [x] I have updated docs/specification.md to reflect the change.\n- [x] I have updated implementations to reflect the change. (This can\nhappen in separate PRs on a feature branch, but must be complete before\nmerging into main.)\n\n## If you have added or changed an implementation\n- [x] I wrote tests for the new implementation using standard fixtures\nsupplied in conftest.py.\n- [x] I updated pyproject.toml with new dependencies if needed.\n- [x] I added a function to tests/bench.py to benchmark the new\nimplementation.\n\n# Further Comments\nIf this is a relatively large or complex change, kick off the discussion\nby explaining why you chose the solution you did and what alternatives\nyou considered, etc...\n\n---------\n\nCo-authored-by: Morgan Schwartz <msschwartz21@gmail.com>",
          "timestamp": "2025-07-23T08:42:08-04:00",
          "tree_id": "88f41ac86996eadc7630c7356d5bb8bb4d633fca",
          "url": "https://github.com/live-image-tracking-tools/geff/commit/1cc3a3cbfa375b78ca3ff6e7267861ed41dbcba8"
        },
        "date": 1753274727414,
        "tool": "pytest",
        "benches": [
          {
            ...
            "extra": "mean: 8.916866254333323 sec\nrounds: 3"
          },
          {
            "name": "tests/bench.py::test_validate",
            "value": 19.42560556414823,
            "unit": "iter/sec",
            "range": "stddev: 0.0008844932760431361",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "32b447183f5d7a4258fc712850238cd659a9742f",
          "message": "Testing functions - PR v2 (#214)\n\nuncommitted changes to #161, which didn't get merged\n\n---------\n\nCo-authored-by: Morgan Schwartz <msschwartz21@gmail.com>",
          "timestamp": "2025-07-23T11:22:40-04:00",
          "tree_id": "2b69221d1b1fd9a7a5cc4013bf5d9edd12be1edb",
          "url": "https://github.com/live-image-tracking-tools/geff/commit/32b447183f5d7a4258fc712850238cd659a9742f"
        },
        "date": 1753284366864,
        "tool": "pytest",
        "benches": [
          {
            ...
            "extra": "mean: 8.771798385000011 sec\nrounds: 3"
          },
          {
            "name": "tests/bench.py::test_validate",
            "value": 19.719576578094866,
            "unit": "iter/sec",
            "range": "stddev: 0.000743957515953484",
          ...
          },
          {
            ...
            "extra": "mean: 15.415859430666663 sec\nrounds: 3"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "2a15885e362116fc7efe00c9089ed9e5eb429351",
          "message": "Command line tool (#200)\n\n# Proposed Change\nAdding `uvx` callable command line tool, solving #178.\n\n# Types of Changes\nWhat types of changes does your code introduce? Delete those that do not\napply.\n- New feature or enhancement\n\n# Checklist\nPut an x in the boxes that apply. You can also fill these out after\ncreating the PR. If you're unsure about any of them, don't hesitate to\nask. We're here to help! This is simply a reminder of what we are going\nto look for before merging your code.\n\n- [x] I have read the\n[developer/contributing](https://github.com/live-image-tracking-tools/geff/blob/main/CONTRIBUTING)\ndocs.\n- [ ] I have added tests that prove that my feature works in various\nsituations or tests the bugfix (if appropriate).\n- [ ] I have checked that I maintained or improved code coverage.\n- [ ] I have written docstrings and checked that they render correctly\nby looking at the docs preview (link left as a comment on the PR).\n\n---------\n\nCo-authored-by: Copilot <175728472+Copilot@users.noreply.github.com>\nCo-authored-by: Morgan Schwartz <msschwartz21@gmail.com>",
          "timestamp": "2025-07-23T12:13:29-04:00",
          "tree_id": "6dcf833a34eb08d325ad8fc406f58d199e7a1013",
          "url": "https://github.com/live-image-tracking-tools/geff/commit/2a15885e362116fc7efe00c9089ed9e5eb429351"
        },
        "date": 1753287370698,
        "tool": "pytest",
        "benches": [
          {
            ...
            "extra": "mean: 8.694455773999985 sec\nrounds: 3"
          },
          {
            "name": "tests/bench.py::test_validate",
            "value": 19.72996647155268,
            "unit": "iter/sec",
            "range": "stddev: 0.0007231199636946035",
          ...
          },
          {
            ...
            "extra": "mean: 15.345796406000005 sec\nrounds: 3"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "80dba089d55c9e12af2bab088838870788b59bb9",
          "message": "Warn about float16 compatibility with java (#206)\n\n# Proposed Change\nCloses #182 \n\n# Types of Changes\nWhat types of changes does your code introduce? Delete those that do not\napply.\n- Bugfix (non-breaking change which fixes an issue)\n- Tests\n\nWhich topics does your change affect? Delete those that do not apply.\n- Specification\n\n# Checklist\nPut an x in the boxes that apply. You can also fill these out after\ncreating the PR. If you're unsure about any of them, don't hesitate to\nask. We're here to help! This is simply a reminder of what we are going\nto look for before merging your code.\n\n- [x] I have read the\n[developer/contributing](https://github.com/live-image-tracking-tools/geff/blob/main/CONTRIBUTING)\ndocs.\n- [x] I have added tests that prove that my feature works in various\nsituations or tests the bugfix (if appropriate).\n- [ ] I have checked that I maintained or improved code coverage.\n- [x] I have written docstrings and checked that they render correctly\nby looking at the docs preview (link left as a comment on the PR).\n\n## If you changed the specification\n- [x] I have checked that any validation functions and tests reflect the\nchanges.\n- [x] I have updated the GeffMetadata and the json schema using `pixi\nrun update-schema` if necessary.\n- [ ] I have updated docs/specification.md to reflect the change.\n- [ ] I have updated implementations to reflect the change. (This can\nhappen in separate PRs on a feature branch, but must be complete before\nmerging into main.)\n\n## If you have added or changed an implementation\n- [x] I wrote tests for the new implementation using standard fixtures\nsupplied in conftest.py.\n- [ ] I updated pyproject.toml with new dependencies if needed.\n- [ ] I added a function to tests/bench.py to benchmark the new\nimplementation.\n\n# Further Comments\nIf this is a relatively large or complex change, kick off the discussion\nby explaining why you chose the solution you did and what alternatives\nyou considered, etc...",
          "timestamp": "2025-07-23T14:59:03-04:00",
          "tree_id": "9452a1f4994d3b61499eaa24a2b2c017155ec306",
          "url": "https://github.com/live-image-tracking-tools/geff/commit/80dba089d55c9e12af2bab088838870788b59bb9"
        },
        "date": 1753297300932,
        "tool": "pytest",
        "benches": [
          {
            ...
            "extra": "mean: 8.777154911333335 sec\nrounds: 3"
          },
          {
            "name": "tests/bench.py::test_validate",
            "value": 19.35666747767544,
            "unit": "iter/sec",
            "range": "stddev: 0.0009452530630994275",
          ...
          },
          {
            ...
            "extra": "mean: 15.309618945333341 sec\nrounds: 3"
          }
        ]
      },
      {
        "commit": {
          "author": {
            "email": "7549583+fjorka@users.noreply.github.com",
            "name": "Kasia Kedziora",
            "username": "fjorka"
          },
          "committer": {
          ...
          "distinct": true,
          "id": "8e0d1fd98c7e80f96108b63dde95e192f8715e82",
          "message": "Validator functions for geff data (#180)\n\n# Proposed Change\nThis branch contains validators for checking different aspects of data\nin geff in response to #152.\nIt also provides a generator of correct and incorrect geff graphs to be\nreplaced with a general approach in #161.\n\n# Types of Changes\nWhat types of changes does your code introduce? Delete those that do not\napply.\n- New feature or enhancement\n- Tests\n\nWhich topics does your change affect? Delete those that do not apply.\n- Specification\n- `networkx` implementation\n\n# Checklist\nPut an x in the boxes that apply. You can also fill these out after\ncreating the PR. If you're unsure about any of them, don't hesitate to\nask. We're here to help! This is simply a reminder of what we are going\nto look for before merging your code.\n\n- [x] I have read the\n[developer/contributing](https://github.com/live-image-tracking-tools/geff/blob/main/CONTRIBUTING)\ndocs.\n- [x] I have added tests that prove that my feature works in various\nsituations or tests the bugfix (if appropriate).\n- [x] I have checked that I maintained or improved code coverage.\n- [ ] I have written docstrings and checked that they render correctly.\n\n## If you changed the specification \n- no change\n\n## If you have added or changed an implementation\n- [ ] I wrote tests for the new implementation using standard fixtures\nsupplied in conftest.py.\n- [ ] I updated pyproject.toml with new dependencies if needed.\n- [ ] I added a function to tests/bench.py to benchmark the new\nimplementation.\n\n---------\n\nCo-authored-by: AnniekStok <anniek.stokkermans@gmail.com>\nCo-authored-by: Caroline Malin-Mayor <malinmayorc@janelia.hhmi.org>",
          "timestamp": "2025-07-23T15:27:00-04:00",
          "tree_id": "13a6bf2c8082385ab5d0fc5be73c33e783f32871",
          "url": "https://github.com/live-image-tracking-tools/geff/commit/8e0d1fd98c7e80f96108b63dde95e192f8715e82"
        },
        "date": 1753299205205,
        "tool": "pytest",
        "benches": [
          {
            ...
            "extra": "mean: 9.271256473666673 sec\nrounds: 3"
          },
          {
            "name": "tests/bench.py::test_validate",
            "value": 19.47592101321977,
            "unit": "iter/sec",
            "range": "stddev: 0.00159930182127614",
