...
def _formatted_schema_json() -> str:
    ...
    # Add comment about this being an autogenerated file that should not be edited
    output = {
        "_comment": (
            "This is an autogenerated file that should not be edited manually. "
            "Changes can be made by modifying the `pydantic.BaseModels` defined in `geff.metadata`."
        ),
        **schema,
    }
